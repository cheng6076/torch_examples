...
function HLSTM.hlstm(rnn_size, n, dropout, word_vocab_size, word_vec_size, char_vocab_size, char_vec_size, length, use_words, use_chars, batch_norm, highway_layers, hsm)
